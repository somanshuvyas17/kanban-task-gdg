...
The board contains 3 columns:- a) Todo
                               b) In Progress
                               c) Done

User can move tasks in between them and review their progress.

Teck Stack Used:- HTML for building webpage.
                  CSS used for layout styling.
